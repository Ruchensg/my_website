---
title: "BBC iPlayer: Cluster Analysis"
author: "Ruchen Shangguan"
date: "`r Sys.Date()`"
output: 
    html_document:
...
<div>![](/Users/shangguanruchen/Documents/portfolioweb/my_website/static/img/BBC.jpg)</div>
...
Use `summary("kmeans Object")` to examgine the components of the results of the clustering algorithm. How many points are in each cluster?
