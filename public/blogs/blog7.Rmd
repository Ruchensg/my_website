...
knitr::include_graphics(here::here("images", "challenge2.png"))
```
...
ggsave("hilary_trump.jpg",plot=hilary_trump,width = 9,height = 4, path = here::here("images"))
# put it here
knitr::include_graphics(here::here("images", "hilary_trump.jpg"))
```
...
# save the picture 
ggsave("top10plot.jpg",plot=top10plot,width = 20,height = 15,path = here::here("images"))
